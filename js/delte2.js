...
function preload() {
    ...
    game.load.image('ground', 'assets/cloudplatform2.png');
...
function create() {
    ...
    backgroundTile = game.add.tileSprite(0, 0, 2000, game.cache.getImage('background').height, 'background');
    ...
    var ground = platforms.create(0, game.world.height - 56, 'groundBottom');
